...
protected:
	...
	void Backup (Snapshot * pdata) { memcpy(static_cast<void*>(pdata), &prev, sizeof(Snapshot)); }
	void Restore(Snapshot * pdata) { memcpy(static_cast<void*>(&prev), pdata, sizeof(Snapshot)); }
